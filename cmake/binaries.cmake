...
SET(SOURCE_DIR "${CMAKE_SOURCE_DIR}/external/gsl")

SET(GSL_INCLUDE_DIRS "${SOURCE_DIR}/include")

SET(INSTALL_DIR "${CMAKE_SOURCE_DIR}/external/zlib")
...
SET(INSTALL_DIR "${CMAKE_SOURCE_DIR}/external/openssl")
...
SET(INSTALL_DIR "${CMAKE_SOURCE_DIR}/external/mariadb")
...
SET(INSTALL_DIR "${CMAKE_SOURCE_DIR}/external/ttvfs")
...
SET(INSTALL_DIR "${CMAKE_SOURCE_DIR}/external/physfs")
...
SET(INSTALL_DIR "${CMAKE_SOURCE_DIR}/external/sqrat")

SET(SQRAT_INCLUDE_DIRS "${INSTALL_DIR}/include")
SET(SQRAT_DEFINES "-DSCRAT_USE_CXX11_OPTIMIZATIONS=1")

SET(INSTALL_DIR "${CMAKE_SOURCE_DIR}/external/civet")
...
SET(INSTALL_DIR "${CMAKE_SOURCE_DIR}/external/squirrel3")
...
SET(INSTALL_DIR "${CMAKE_SOURCE_DIR}/external/asio")

SET(ASIO_INCLUDE_DIRS "${INSTALL_DIR}/src/asio/asio/include")

SET(INSTALL_DIR "${CMAKE_SOURCE_DIR}/external/tinyxml2")
...
SET(INSTALL_DIR "${CMAKE_SOURCE_DIR}/external/googletest")
...
SET(INSTALL_DIR "${CMAKE_SOURCE_DIR}/external/jsonbox")
