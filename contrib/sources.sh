...
curl -L --url https://github.com/comphack/zlib/archive/comp_hack-20180424.zip --output zlib.zip
curl -L --url https://github.com/comphack/openssl/archive/comp_hack-20180424.zip --output openssl.zip
curl -L --url https://github.com/comphack/mariadb/archive/comp_hack-20180424.zip --output mariadb.zip
...
curl -L --url https://github.com/comphack/googletest/archive/comp_hack-20180424.zip --output googletest.zip
