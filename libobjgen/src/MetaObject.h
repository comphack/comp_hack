...
protected:
    ...
    std::shared_ptr<MetaVariable> GetVariable(const tinyxml2::XMLDocument& doc, const char *szName,
...
private:
    ...
    const tinyxml2::XMLElement *GetChild(const tinyxml2::XMLElement *pMember, const std::string name) const;
