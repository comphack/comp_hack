...
ExternalProject_Add(
    ...
    CMAKE_ARGS -DCMAKE_RELWITHDEBINFO_POSTFIX=_reldeb -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR>
...
ExternalProject_Add(
    ...
    CMAKE_ARGS -DCMAKE_RELWITHDEBINFO_POSTFIX=_reldeb -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DSKIP_INSTALL_FILES=ON -DUSE_STATIC_RUNTIME=${USE_STATIC_RUNTIME}
...
ExternalProject_Add(
    ...
    CMAKE_ARGS -DCMAKE_RELWITHDEBINFO_POSTFIX=_reldeb -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DUSE_STATIC_RUNTIME=${USE_STATIC_RUNTIME} -DCMAKE_DEBUG_POSTFIX=d -DBUILD_VALGRIND_FRIENDLY=${BUILD_VALGRIND_FRIENDLY}
...
ExternalProject_Add(
    ...
    CMAKE_ARGS -DCMAKE_RELWITHDEBINFO_POSTFIX=_reldeb -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> "-DCMAKE_CXX_FLAGS=-std=c++11 ${SPECIAL_COMPILER_FLAGS}" "-DOPENSSL_ROOT_DIR=${OPENSSL_ROOT_DIR}" -DUSE_STATIC_RUNTIME=${USE_STATIC_RUNTIME} -DCMAKE_DEBUG_POSTFIX=d -DWITH_OPENSSL=ON
...
ExternalProject_Add(
    ...
    CMAKE_ARGS -DCMAKE_RELWITHDEBINFO_POSTFIX=_reldeb -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> "-DCMAKE_CXX_FLAGS=-std=c++11 ${SPECIAL_COMPILER_FLAGS}" -DUSE_STATIC_RUNTIME=${USE_STATIC_RUNTIME} -DCMAKE_DEBUG_POSTFIX=d
...
ExternalProject_Add(
    ...
    CMAKE_ARGS -DCMAKE_RELWITHDEBINFO_POSTFIX=_reldeb -DCMAKE_INSTALL_PREFIX:PATH=<INSTALL_DIR> -DBUILD_SHARED_LIBS=OFF "-DCMAKE_CXX_FLAGS=-std=c++11 ${SPECIAL_COMPILER_FLAGS}" -DUSE_STATIC_RUNTIME=${USE_STATIC_RUNTIME} -DCMAKE_DEBUG_POSTFIX=d
