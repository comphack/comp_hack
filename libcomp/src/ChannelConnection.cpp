...
void ChannelConnection::SocketError(const libcomp::String& errorMessage)
{
...
void ChannelConnection::ConnectionSuccess()
{
    LOG_DEBUG(libcomp::String("Client connection: %1\n").Arg(
        GetRemoteAddress()));
}

void ChannelConnection::ConnectionEncrypted()
{
...
void ChannelConnection::PacketReceived(libcomp::Packet& packet)
{
